    ...
    <div class="game">
        ...
        <div class="right">
            ...
            <div style="flex-direction: row; display: flex;">
                <form action="/kjnjuhuu" method="Post" style=" display: flex; gap:10px; ">
                ...
                <form id="formDelete" style=" position: relative;" action="" method="POST" onsubmit="return confirm('Are you sure you want to delete scores ?')">
                    @csrf
                    @method('DELETE')
                    <button type="submit" id="Btn-delete" data-game="{{$game->slug}}" class="Deleted"  style="left:60%;position: absolute " >
